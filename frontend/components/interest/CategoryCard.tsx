...
export default function CategoryCard({ option, onSelect, disabled }: CategoryCardProps) {
  return (
    <button
      ...
      disabled={disabled}
      className="w-full text-left p-3 rounded-2xl border-1 border-indigo-300 bg-white hover:border-indigo-300 hover:bg-indigo-50 active:scale-[0.98] transition-all duration-150 disabled:opacity-50 disabled:cursor-not-allowed"
    >
